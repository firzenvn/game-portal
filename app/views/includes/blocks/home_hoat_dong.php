...
$category = \EModel\Category::where('group_code', '=', \Util\CommonConstant::CATEGORY_SUB_ARTICLE)
    ->where('code', '=', \Util\CommonConstant::CATEGORY_ARTICLE_HOAT_DONG_CODE)->first();
$allArticles = array();
if($category)
...
?>
<div class="row">
    <section class="hoatdong-nav"><h3><a href="<?php echo isset($linkNav)?$linkNav:'#' ?>"><?php if($category) echo $category->name ?></a></h3></section>
    <section class="hoatdong-content">
