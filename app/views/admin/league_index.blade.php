<?php
$edit_url = '/'.$urlSegment.'/league/edit/';
$new_url = '/'.$urlSegment.'/league/new/';
$delete_url= '/'.$urlSegment.'/league/delete/';
$winner_url = '/'.$urlSegment.'/league/winner/';
?>
...
@include('includes.messaging')
    {{Form::open(array('url'=>'/'.$urlSegment.'/league', 'method'=>'get', 'role'=>'form'))}}
    ...
    <tr>
        ...
        <td>
            <div class="pull-right">
                <a href="{{ $winner_url.$item->id }}" class="btn btn-sm btn-primary">Người thắng cuộc</a>
