<?php namespace Util\Model;
use Illuminate\Support\Facades\Auth;
use Util\Exceptions\NoValidationRulesFoundException;
...
//            $this->saveTags('');
    ...
    {
        return in_array( 'Util\Model\Traits\TaggableRelationship' , ( new ReflectionClass( $this ) )->getTraitNames() );
    }
    ...
    {
        return in_array( 'Util\Model\Traits\UploadableRelationship' , ( new ReflectionClass( $this ) )->getTraitNames() );
    }
