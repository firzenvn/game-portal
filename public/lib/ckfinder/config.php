...
/*$core_path = dirname(dirname(dirname(dirname(dirname(dirname(dirname($_SERVER['SCRIPT_FILENAME'])))))));
include_once($core_path.'/application/config/startup.php');
try {
    Bootstrap::runWithoutDispath();
...
{
//        if ( Illuminate\Support\Facades\Session::get('isLoggedIn') ) return true;
